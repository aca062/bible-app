...
/**
 * Controlador para gestionar las solicitudes relacionadas con los libros de la
 * Biblia.
...
public class BookController {
	@Autowired
	BookRepository bookRepository; // Repositorio para acceder a los datos de los libros de la Biblia.
